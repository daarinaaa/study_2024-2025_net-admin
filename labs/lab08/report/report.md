...
Затем маршрутизатор выделяет адрес нужному mac-адресу на основе информации об уже занятых в этой подсети адресах. Он отправляет ответ устройству о том, какой именно адрес выделен. Теперь в заголовках указан адрес шлюза подсети и адрес устройства. После того, как устройство получило адрес, оно сообщает маршрутизатору о принятии этого адреса.
